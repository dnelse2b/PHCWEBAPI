...
public class Cl
{
	...
	public bool UAgua { get; set; }

	public bool ULuz { get; set; }

	public decimal UNestac { get; set; }

	public decimal UNomoeda { get; set; }
	...
	public bool UAdmviz { get; set; }

	public string Contamovinc { get; set; }

	public string Contadivinc { get; set; }
	...
	public string UNrgarant { get; set; }

	public string UMoeda { get; set; }

	public DateTime UDtval { get; set; }

	public decimal UValorgar { get; set; }

	public DateTime UDtegar { get; set; }

	public string UTerminal { get; set; }
}
