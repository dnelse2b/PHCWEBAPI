...
public class Bo
{
	...
	public string UReentry { get; set; }

	public string URefctt { get; set; }

	public DateTime UDtctt { get; set; }

	public string UNguia { get; set; }

	public string UManif { get; set; }

	public string UBoact { get; set; }

	public string UBocont { get; set; }

	public string UBoempr { get; set; }

	public string UBomora { get; set; }

	public string UBonots { get; set; }

	public decimal UBonuit { get; set; }

	public string UBoobs { get; set; }

	public decimal UBotel { get; set; }

	public decimal UIva { get; set; }

	public decimal UTotiva { get; set; }

	public decimal UBocam { get; set; }

	public decimal UBotot { get; set; }

	public decimal UBoiva { get; set; }

	public decimal UMcam { get; set; }

	public bool UAnulada { get; set; }

	public decimal ULeiact { get; set; }

	public decimal UFact { get; set; }

	public string UContaff { get; set; }

	public decimal UContado { get; set; }

	public string UBancoff { get; set; }

	public decimal UMntfixo { get; set; }

	public decimal UTdndoc { get; set; }

	public string UNavio { get; set; }

	public decimal UAnocm { get; set; }

	public string UCm { get; set; }

	public string UEstcod { get; set; }

	public string UEstdesc { get; set; }
	...
	public bool UNcontref { get; set; }

	public decimal UImo { get; set; }

	public string UCotstamp { get; set; }

	public DateTime UDaprova { get; set; }

	public string UHaprova { get; set; }

	public string UNaprova { get; set; }

	public decimal UValoradm { get; set; }

	public string UBostamp { get; set; }
}
