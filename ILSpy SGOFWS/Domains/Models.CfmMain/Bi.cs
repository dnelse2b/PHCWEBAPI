...
public class Bi
{
	...
	public decimal UBicam { get; set; }

	public decimal UBitot { get; set; }
	...
	public string UConta { get; set; }

	public decimal UMcam { get; set; }

	public decimal UCif { get; set; }
	...
	public bool UPapagar { get; set; }

	public string UTcarga { get; set; }
	...
	public string URefctt { get; set; }

	public bool ULtrigger { get; set; }

	public string UOlcodigo { get; set; }

	public decimal USaldo { get; set; }

	public string UViatura { get; set; }

	public string UGastos { get; set; }

	public string UIdpacien { get; set; }

	public string UNmpacien { get; set; }

	public bool ULogi1 { get; set; }

	public string UMlogi1 { get; set; }

	public decimal UOperacao { get; set; }

	public string UEquip { get; set; }

	public string UBi { get; set; }

	public string UStampart { get; set; }

	public decimal UPrecoadm { get; set; }

	public decimal UValoradm { get; set; }

	public string UTipest { get; set; }

	public decimal UValortd { get; set; }

	public decimal UPctg { get; set; }

	public decimal UPct { get; set; }

	public decimal UVmoeda { get; set; }

	public decimal UTxcambio { get; set; }

	public string UMoeda { get; set; }

	public bool UCambfixo { get; set; }

	public bool UItobrig { get; set; }

	public bool UDescobri { get; set; }

	public string UMcstamp { get; set; }

	public decimal UMancod { get; set; }

	public decimal UKm { get; set; }

	public string UReferen { get; set; }

	public string URefcarta { get; set; }

	public decimal UGastoite { get; set; }

	public decimal USaldoite { get; set; }
}
