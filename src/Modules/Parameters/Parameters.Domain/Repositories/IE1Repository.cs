...
{
    Task<Para1?> GetByStampAsync(string paraStamp, CancellationToken cancellationToken = default);
    ...
    Task<bool> ExistsAsync(string paraStamp, CancellationToken cancellationToken = default);
